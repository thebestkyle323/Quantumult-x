...
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://raw.githubusercontent.com/thebestkyle323/Quantumult-x/main/heji.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/thebestkyle323/Quantumult-x/main/heji.js
...
try {
  if (typeof $response == "undefined") {
    ...
    const subData = Object.assign({},data,{		"Author": "chxm1023",		"Telegram": "https://t.me/iSharesubcribe",		"warning": "仅供学习，禁止转载或售卖",		"original_purchase_date": "2023-09-09T09:09:09Z",		"store_transaction_id" : "4900066666666666",		"period_type" : "trial",		"store": "app_store",		"ownership_type": "PURCHASED"	});
    ...
    iSharesubcribe.body = JSON.stringify(chxm1023);
    console.log('已操作成功🎉🎉🎉\nhttps://t.me/iSharesubcribe');
  } 
} catch(e) {
  //执行失败
